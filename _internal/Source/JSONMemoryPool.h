...
#ifdef JSON_PREPARSE
	#define NODEPOOL jsonPoolPart(sizeof(JSONWGNode), 1)
	#define INTERNALNODEPOOL jsonPoolPart(sizeof(internalWGJSONWGNode), 3)
...
#else
	#define NODEPOOL jsonPoolPart(sizeof(JSONWGNode), 2)
	#define INTERNALNODEPOOL jsonPoolPart(sizeof(internalWGJSONWGNode), 7)
